        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            <select
              ...
              className="px-3 py-2 border border-slate-700 rounded-lg text-sm bg-slate-800 text-white hover:border-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors">
