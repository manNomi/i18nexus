...
Options:
  ...
  -n, --namespace <ns>       번역 네임스페이스 (기본값: "common")
  -o, --output-dir <dir>     번역 파일 출력 디렉토리 (기본값: "./locales")
  -d, --dry-run             실제 수정 없이 미리보기
  -h, --help                도움말 표시

Examples:
  i18n-wrapper                                    # 기본 설정으로 한국어 문자열 처리
  i18n-wrapper -p "app/**/*.tsx" -n "components"  # 커스텀 패턴과 네임스페이스
  i18n-wrapper --dry-run                          # 변경사항 미리보기
  
Features:
  - 한국어 문자열 자동 감지 및 t() 래핑
